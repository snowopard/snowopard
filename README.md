...
I design and implement backend-first systems with a strong focus on security, access control, and data integrity.

I’m comfortable working across the stack, but my strength is in backend architecture — APIs, authentication, authorization, auditability — and building UIs that accurately reflect backend state.
